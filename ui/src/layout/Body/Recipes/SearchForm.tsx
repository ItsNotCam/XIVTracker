...
const SearchBar: React.FC<SearchBarProps> = ({ handleSearch, isSearching }) => {
	...
	return (
		<form onSubmit={handleSubmit} className="
			w-[clamp(2rem,40vw,45rem)] rounded-full bg-custom-gray-900 
		...
		">
				...
				<input type="text" className="bg-transparent outline-none focus:outline-none grow" name="recipe-search-name"/>
